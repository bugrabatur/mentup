...
const sliderSettings = {
  ...
  responsive: [
    {
      breakpoint: 700, // 700px ve altı için
      settings: {
        slidesToShow: 1,
        speed: 35000, // Daha yavaş kaydırma
      }
    }
  ]
};
        ...
        <section className="home-mentor-slider-section">
          ...
          <Slider {...sliderSettings}>
            {mentors.map((mentor) => {
              ...
              return (
                <div key={mentor.id} className='home-mentor-card-container' style={{width: "100%"}}>
                  <div className="home-mentor-card" style={{position: "relative"}}>
                    {/* Rating sağ üst köşe */}
                    <div
